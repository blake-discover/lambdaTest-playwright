...
(async () => {
  ...
  try {
    ...
    browser = await chromium.connectOverCDP(
      `wss://cdp.lambdatest.com/playwright-cdp?capabilities=${encodeURIComponent(
    ...
    try {
      ...
      `lambdatest_action: ${JSON.stringify({ action: "setTestStatus", arguments: { status: "passed", remark: "Data matched" } })}`);
    } catch (e) {
      await page.evaluate((_) => {},
